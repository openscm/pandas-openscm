...
- - Added a method for converting to long data, see `pandas_openscm.accessors.PandasDataFrameOpenSCMAccessor.to_long_data` ([#12](https://github.com/openscm/pandas-openscm/pull/12))
